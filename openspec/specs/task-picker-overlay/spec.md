# task-picker-overlay Specification

## Purpose
Defines the task picker overlay: a selection-only overlay that lists standalone open tasks and broadcasts the chosen task to the calling screen, leaving any mutating operation and error handling to the caller.
