# inbox-service Specification

## Purpose
Defines the Item domain type, the InboxService interface for capturing and listing inbox items, and the SQLite-backed persistence for unprocessed captures.
