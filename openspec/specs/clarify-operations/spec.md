# clarify-operations Specification

## Purpose
Defines the clarify operations exposed by InboxService that move an inbox Item into one of the GTD destinations (task, project, someday-project, or discard) atomically, along with the invariants that prevent double-clarification.
