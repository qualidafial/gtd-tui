# project-picker-overlay Specification

## Purpose
Defines the behavior of the project picker overlay, which allows assigning or unlinking a project from a task using a select list of open projects.
