# app-error-bar Specification

## Purpose
Defines the centralized error display in the application's help bar row: how errors from screens are intercepted, displayed, replaced, and cleared, and how screens cooperate by surfacing errors as messages rather than rendering them locally.
